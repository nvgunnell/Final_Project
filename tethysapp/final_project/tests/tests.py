    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.final_project"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.final_project.tests.tests"

        To run tests in the FinalProjectTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.final_project.tests.tests.FinalProjectTestCase"

        To run only the test_if_tethys_platform_is_great function in the FinalProjectTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.final_project.tests.tests.FinalProjectTestCase.test_if_tethys_platform_is_great"
...
class FinalProjectTestCase(TethysTestCase):
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/final-project/')  # The final '/' is essential for all pages/controllers
